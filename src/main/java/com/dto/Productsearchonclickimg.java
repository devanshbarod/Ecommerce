...
/**
 * Servlet implementation class Productsearchonclickimg
 */
@WebServlet("/Productsearchonclickimg")
public class Productsearchonclickimg extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Productsearchonclickimg() {
        super();
