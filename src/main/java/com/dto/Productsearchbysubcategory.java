...
/**
 * Servlet implementation class Productsearchbysubcategory
 */
@WebServlet("/Productsearchbysubcategory")
public class Productsearchbysubcategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Productsearchbysubcategory() {
        super();
