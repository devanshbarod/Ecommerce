...
/**
 * Servlet implementation class Allsubcategory
 */
@WebServlet("/Allsubcategory")
public class Allsubcategory extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Allsubcategoryget> showsubcategory = db2.showAllsubcategory();
