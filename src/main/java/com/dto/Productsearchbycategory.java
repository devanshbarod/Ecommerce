...
/**
 * Servlet implementation class Productsearchbycategory
 */
@WebServlet("/Productsearchbycategory")
public class Productsearchbycategory extends HttpServlet {
     ...
     */
    public Productsearchbycategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(prosearch != null) {
			...
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/Showrelatedproduct.jsp");
