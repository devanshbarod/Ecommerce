...
<style>
    ...
    <%
		...
		ArrayList showquery = db.showAllquery();
		session.setAttribute("showquery", showquery);
	%>
	 <div class="container">
        <div class="header">
            <div>C_ID</div>
            ...
            <%
	        	ArrayList al = (ArrayList)session.getAttribute("showquery");
	        	if(al!=null){
        		for(int i=0;i<al.size();i++){
        			Allqueryget st = (Allqueryget)al.get(i);
        		
        	%>
        <div class="data-row">
            <div class="cell"><%= st.getCid() %></div>
            <div class="cell"><%= st.getEmail()%></div>
            <div class="cell"><%= st.getMessage()%></div>
             <div class="cell"></div>
            <div class="button-group">
            <a class="delete-btn" href="Subcategorydelete?subid=<%=st.getCid()%>">Delete</a>
            </div>
        </div>
