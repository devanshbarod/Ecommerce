          ...
          >
            <div class="container h-full">
              <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                ...
                >
                  <a
                    href="Productsearchonclickimg?pid=26"
            ...
            <div class="container h-full">
              <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div
                  ...
                  data-delay="0"
                >
                  <span class="ltext-101 cl2 respon2"> Rs. 1000 </span>
                </div>
                ...
                >
                  <a
                    href="Productsearchonclickimg?pid=28"
                    class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04"
                  >
                    Shop Now
                  </a>
            ...
            <div class="container h-full">
              <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div
                  ...
                  data-delay="0"
                >
                  <span class="ltext-101 cl2 respon2"> Rs. 3000 </span>
                </div>
                ...
                >
                  <a
                    href="Productsearchonclickimg?pid=27"
                    class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04"
                  >
                    Shop Now
                  </a>
        ...
        <div class="row">
          <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="Productsearchbycategory?cname=watch"
          ...
          <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="Productsearchbycategory?cname=mobile"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
          ...
          <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="Productsearchbycategory?cname=earbud"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
   ...
   <div class="con2">
    <div class="product-grid">
	    ...
	    <div class="block2">
	        ...
	        <a href="Productsearchonclickimg?pid=<%= st.getProduct_id() %>">
