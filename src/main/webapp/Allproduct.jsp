...
<style>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="cell"><%= st.getCategory() %></div>
            <div class="cell"><%= st.getBrand() %></div>
            <div class="cell"><%= st.getQty() %></div>
            <div class="cell"><%= st.getPrice() %></div>
            <div class="cell"><%= st.getSubtotal() %></div>
            <div class="button-group">
                <a class="button update-btn" href="productSearch?pid=<%= st.getProduct_id() %>">Update</a>
            </div>
            <div class="button-group">
                <a class="button delete-btn" href="Productdelete?pid=<%= st.getProduct_id() %>">Delete</a>
            </div>
            <div class="cell"></div>
        </div>
             <%
