...
function showHint(str) {
  ...
  <body class="animsition">
	...
	<%
	        	ArrayList al = (ArrayList)session.getAttribute("showrelatedsubcategory");
	        	if(al!=null){
    ...
    <div>
    	<nav class="link-list">
	    <a href="Productsearchbysubcategory?pname=<%= st.getSubcategory_name()%>&cname=<%= st.getCategoryname() %>"><%= st.getSubcategory_name()%></a>
	  </nav>	
    </div>
	...
	<%
	        	ArrayList al2 = (ArrayList)session.getAttribute("prosearchbysubcat");
	        	if(al2!=null){
    ...
    <div class="product-card">
      <div class="product-info-container">
        ...
        <div class="product-details">
          <a href="Productsearchonclickimg?pid=<%= st.getProduct_id() %>" class="product-name">
            <%= st.getProduct_name() %>
          </a>
