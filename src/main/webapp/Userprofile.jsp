        ...
        <div class="data">
            <form action="Userprofileupdate" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="fname" id="fname" value="<%=user.getFname() %>">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="" value="<%=user.getEmail() %>">
                </div>
                <div>
                    <label for="">Mobile</label>
                    <label for="" id="a2">Gender</label><br>
                    <input type="number" name="mobnumber" id="" value="<%=user.getMobnumber() %>">
                    <input type="text" name="gender" id="" value="<%=user.getGender() %>">
                </div>
                <div>
                    <label for="">Date of Birth</label>
                    <label for="" id="a3">Address</label><br>
                    <input type="date" name="dob" id="" value="<%=user.getDob() %>">
                ...
                <div>
                    ...
                    <input type="text" name="role" id="" readonly value="<%=user.getRole() %>">
                </div>
