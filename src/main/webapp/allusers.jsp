...
<style>
    ...
    <%
		...
		ArrayList showusers = db.showAll();
    ...
    <div class="container">
        ...
        <%
	        	ArrayList al = (ArrayList)session.getAttribute("showusers");
	        	if(al!=null){
        		for(int i=0;i<al.size();i++){
        			Allusersget st = (Allusersget)al.get(i);
        		
        	%>
        <div class="user-row">
            <div class="cell"><%=st.getUsername() %></div>
            <div class="cell"><%=st.getFname() %></div>
            <div class="cell"><%=st.getEmail() %></div>
            <div class="cell"><%=st.getMobnumber() %></div>
            <div class="cell"><%=st.getDob() %></div>
            <div class="cell"><%=st.getGender() %></div>
            <div class="cell"><%=st.getState() %></div>
            <div class="cell"><%=st.getAddress() %></div>
            <div class="button-group">
                <a class="button update-btn" href="AdminUserUpdate?usernm=<%=st.getUsername() %>">Update</a>
            </div>
            <div class="button-group">
                <a class="button delete-btn" href="Adminuserdelete?user=<%=st.getUsername() %>">Delete</a>
            </div>
            <div class="cell"></div>
        </div>
   <%
