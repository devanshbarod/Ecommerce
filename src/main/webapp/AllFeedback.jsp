...
<div class="container">
		...
		ArrayList showfeedback = db.showAllFeedback();
		session.setAttribute("showfeedback", showfeedback);
	%>
        <%
	        	ArrayList al = (ArrayList)session.getAttribute("showfeedback");
	        	if(al!=null){
        		for(int i=0;i<al.size();i++){
        			AllFeedbackget st = (AllFeedbackget)al.get(i);
        		
        	%>
        <div class="user-row">
            <div class="cell"><%=st.getFid() %></div>
            <div class="cell"><%=st.getName() %></div>
            <div class="cell"><%=st.getEmail() %></div>
            <div class="cell"><%=st.getExpirence() %></div>
            <div class="cell"><%=st.getRating() %></div>
            <div class="cell"><%=st.getEase_to_use() %></div>
            <div class="cell"><%=st.getDesign() %></div>
            <div class="cell"><%=st.getPerformance() %></div>
            <div class="cell"><%=st.getSuggesion() %></div>
            <div class="button-group">
                <a class="button delete-btn" href="AdminFeedbackdelete?fid=<%=st.getFid() %>">Delete</a>
            </div>
            <div class="cell"></div>
        </div>
